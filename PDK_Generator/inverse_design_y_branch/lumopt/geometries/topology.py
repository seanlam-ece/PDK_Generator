...
class TopologyOptimization2DParameters(Geometry):
    ...
    def __init__(self, params, eps_min, eps_max, x, y, z, filter_R, eta, beta, eps=None):
...
class TopologyOptimization2D(TopologyOptimization2DParameters):
    ...
    def __init__(self, params, eps_min, eps_max, x, y, z=0, filter_R=200e-9, eta=0.5, beta=1, eps=None):
        super().__init__(params, eps_min, eps_max, x, y, z, filter_R, eta, beta, eps)
