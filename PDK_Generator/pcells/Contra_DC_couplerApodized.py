...
class Contra_DC_couplerApodized(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("gap", self.TypeDouble, "Minimum gap (microns)", default = {gap})
    ...
    self.param("H", self.TypeDouble, "Apodization H constant (microns)", default = {apodization-constant})
