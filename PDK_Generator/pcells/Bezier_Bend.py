...
class Bezier_Bend(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("bezier_num", self.TypeDouble, "Bezier factor", default = {bezier-factor})     
    self.param("eff_r", self.TypeDouble, "Effective bend radius (microns)", default = {bend-radius})
...
#    self.param("textl", self.TypeLayer, "Text Layer", TECHNOLOGY['{{Layer}Text}'], hidden = True)
