...
class Bent_Coupled_Half_Ring(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("bus_radius", self.TypeDouble, "Bus Radius", default = {bus-radius})
    self.param("gap", self.TypeDouble, "Gap", default = {gap})
    self.param("bus_width", self.TypeDouble, "Bus Width", default = {bus-width})
    self.param("ring_width", self.TypeDouble, "Ring Width", default = {ring-width})
    self.param("bend_angle", self.TypeDouble, "Bend angle", default = {bend-angle})
