...
class fswgc(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("wavelength", self.TypeDouble, "Design Wavelength (micron)", default = {wavelength})  
    self.param("n_t", self.TypeDouble, "Cladding Index", default = {cladding-index})
    self.param("n_e", self.TypeDouble, "Grating Effective Index", default = {grating-effective-index})
    ...
    self.param("dc", self.TypeDouble, "Duty Cycle", default = {duty-cycle})
    self.param("period", self.TypeDouble, "Grating Period", default = {grating-period})
    self.param("ff", self.TypeDouble, "Fill Factor", default = {fill-factor})
