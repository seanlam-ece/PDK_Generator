...
class Contra_DC_chirped(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("grating_period_start", self.TypeDouble, "Start grating period (microns)", default = {grating-period-start})
    self.param("grating_period_end", self.TypeDouble, "Start grating period (microns)", default = {grating-period-end})
