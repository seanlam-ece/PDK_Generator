...
class Waveguide_Arc(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("wg_width", self.TypeDouble, "Waveguide Width", default = {width})
    self.param("start_angle", self.TypeDouble, "Start Angle", default = {start-angle})
    self.param("stop_angle", self.TypeDouble, "Stop Angle", default = {stop-angle})
