...
class DirectionalCoupler_SeriesRings(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("r2", self.TypeDouble, "Radius of Upper Ring", default = {upper-ring-radius})
    self.param("r1", self.TypeDouble, "Radius of Lower Ring", default = {lower-ring-radius})
