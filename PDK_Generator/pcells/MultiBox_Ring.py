...
class MultiBox_Ring(pya.PCellDeclarationHelper):
    ...
    def __init__(self):
      ...
      self.param("gap2", self.TypeDouble, "Bus Gap [um]", default = {bus-gap})
      self.param("row", self.TypeDouble, "Number of Rows", default = {number-rows})
      self.param("busL", self.TypeDouble, "Bus Length [um]", default = {bus-length})
