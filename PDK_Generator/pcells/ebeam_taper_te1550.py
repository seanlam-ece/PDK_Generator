...
class ebeam_taper_te1550(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("wg_width1", self.TypeDouble, "Waveguide Width1 (CML only supports 0.4, 0.5, 0.6)", default = {waveguide-width1})
    self.param("wg_width2", self.TypeDouble, "Waveguide Width2 (CML only supports 1, 2, 3)", default = {waveguide-width2})
    self.param("wg_length", self.TypeDouble, "Waveguide Length (CML only supports a range of 1-10)", default = {waveguide-length})
